  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (status >= 400) setError("Invalid Username or Password");
        ...
        setError(
          "Failed to verify Login Credentials due to Server Error, our team is working on it. Please try again later."
        );
    }
  };
            ...
            >
              ...
              >
                <TextField
                  ...
                  helperText={
                    submitted && !email ? `Please enter your email address` : ""
                  }
                />
                <TextField
                ...
                <Button
                  ...
                  sx={{
                    mt: 3,
                    mb: 2,
                    backgroundColor: "#b887f5",
                    "&:hover": { backgroundColor: "#894cd4" },
                  }}
                >
                  Sign In
                </Button>
