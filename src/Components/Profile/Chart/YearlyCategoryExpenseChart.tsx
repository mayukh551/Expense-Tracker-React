...
function YearlyCategoryExpenseChart() {
  ...
  return (
    <div>
        <div className="chart-wrapper">
            ...
            <h4 className='mt-4 text-base font-bold px-4 py-2 rounded-md shadow-md w-fit mx-auto'>Yearly Category Wise Expense Chart</h4>
        </div>
    </div>
  )
}

export default YearlyCategoryExpenseChart;