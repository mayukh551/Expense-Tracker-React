...
export const SavedAmount: React.FC<any> = (props) => {
    ...
    return (
        ...
        <div className="bg-green-600 rounded-lg py-2 px-8 w-40 md:w-fit flex flex-col justify-center md:text-left text-center">
...
export const PurchasedAmount: React.FC<any> = (props) => {
    ...
    return (
        // create a card to display the saved amount with light green background using tailwindcss
        <div className="py-2 bg-purple-600 rounded-lg px-8 w-40 md:w-fit flex flex-col justify-center md:text-left text-center">
...
export const TotalItems: React.FC<any> = (props) => {
    ...
    return (
        // create a card to display the saved amount with light green background using tailwindcss
        <div className="py-2 bg-yellow-400 rounded-lg px-8 w-40 md:w-fit flex flex-col justify-center md:text-left text-center">
